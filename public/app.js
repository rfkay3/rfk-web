(() => {
  ...
  var Counter = () => {
    ...
    return {
      view: () => (0, import_mithril.default)(
        "div",
        (0, import_mithril.default)("h2", "Counter"),
        (0, import_mithril.default)("h3", num),
        (0, import_mithril.default)("button", { onclick: () => num += 1 }, "Increment"),
        (0, import_mithril.default)("button", { onclick: () => num -= 1 }, "Decrement")
      )
    };
  };
  ...
  var Input = () => {
    let value = "";
    return {
      view: () => /* @__PURE__ */ (0, import_mithril2.default)("[", null, /* @__PURE__ */ (0, import_mithril2.default)("h2", null, "JSX Input Component"), /* @__PURE__ */ (0, import_mithril2.default)(
        "input",
        {
          type: "text",
          value,
      ...
      ), /* @__PURE__ */ (0, import_mithril2.default)("h3", null, value || "this component uses JSX"))
    };
  };
